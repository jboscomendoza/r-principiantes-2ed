...
*R para principiantes* pretende ser un material introductorio al lenguaje de programación R, dirigido a personas que nunca han usado R o ningún otro lenguaje de programación, ni tiene conocimiento previo de probabilidad y estadística.
...
No son objetivos de este libro que aprendas probabilidad y estadística, ni las aplicaciones específicas de estas disciplinas, tales como son *data science*, aprendizaje automático, econometría, psicometría, bioestadística u otros.
...
Ha colaborado en los Comités Interinstitucionales para la Evaluación de la Educación Superior (CIEES) como elaborador de informes de evaluación institucional y como consultor independiente en análisis de datos y psicometría para INNOVA Schools, el Centro Nacional de Evaluación para la Educación Superior (CENEVAL), The World Bank Group y el Banco Interamericano de Desarrollo (BID).
