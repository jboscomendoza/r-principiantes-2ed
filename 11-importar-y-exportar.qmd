# Importar y exportar datos {#sec-importar}
...
Probemos con un archivo con extensión ".data", descargado desde el repositorio de [Github](http://www.github.com/jboscomendoza/r-principiantes-2ed) de este libro. 
```{r descarga cancer.data, echo=TRUE, eval=FALSE}
download.file(
  url = "https://raw.githubusercontent.com/jboscomendoza/r-principiantes-2ed/master/datos/breast-cancer-wis.data", 
...
* https://raw.githubusercontent.com/jboscomendoza/r-principiantes-2ed/master/datos/breast-cancer-wis.names
...
download.file(
  url = "https://raw.githubusercontent.com/jboscomendoza/r-principiantes-2ed/master/datos/breast-cancer-wis.csv", 
...
Usamos la función `install.packages()`, como lo vimos en el [capítulo 3](##paquetes)
...
download.file(
  url = "https://github.com/jboscomendoza/r-principiantes-2ed/raw/master/datos/data_frames.xlsx", 
