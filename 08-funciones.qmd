...
## ¿Por qué necesitamos crear nuestrar propias funciones? {#sec-funciones-porque}
...
Esto es sencillo de resolver pues contamos con la función `hist()` que hace exactamente esto. Sólo tenemos que dar un vector numérico como argumento para generar una gráfica (veremos esto con más detalle en el [Capítulo @sec-graficas].
...
## Funciones definidas por el usuario {#sec-funciones-usuario}
...
## Nuestra primera función {#sec-funciones-primera}
...
## Definiendo la función `crear_histograma()` {#sec-funciones-histograma}
...
### Ejecutando {#sec-funciones-ejecucion}
