# Estructuras de datos {#sec-estructuras-datos}
Las estructuras de datos son las maneras en que los objetos contienen datos, cuando trabajamos con R lo que estamos haciendo es manipular estas estructuras.

Lo que que distingue a una estructura de otra son dos características principales: su número de **dimensiones**, y si es **homogenea** o **hereterogenea**, es decir, si contiene datos que comparten el mismo tipo o contiene datos de diferentes tipos, respectivamente.
...
2          | Matriz    | Data frame 
n          | Array     | 
*Adaptado de [@wickham2023].*

Veamos las características de cada una de ellas.

## Vectores {#sec-estructuras-vectores}
Un vector es la estructura de datos más sencilla en R. Un vector es una colección unidimensional de uno o más datos homogéneos. Los vectores son **atómicos**, pues sólo pueden contener datos de un único tipo, no es posible mezclar datos de tipos diferentes dentro de ellos.

Todos los vectores tienen tres propiedades:

* **Tipo**. Un vector tiene el mismo tipo que los datos que contiene. Por ejemplo, si tenemos un vector que contiene datos de tipo numérico, el vector será también de tipo numérico. 
...
### Creación de vectores {#sec-estructuras-vectores-creacion}
...
### Vectorización de operaciones {#sec-estructuras-vectores-vectorizacion}
...
## Matrices y arrays {#sec-estructuras-matrices}
...
### Creación de matrices {#sec-estructuras-matrices-creacion}
...
### Propiedades de las matrices {#sec-estructuras-matrices-propiedades}
...
## Data frames {#sec-estructuras-dataframes}
...
### Propiedades de un data frame {#sec-estructuras-dataframes-propiedades}
...
### Propiedades de una lista {#sec-estructuras-listas-propiedades}
...
## Coerción {#sec-estructuras-coercion}
...
Función           | Intenta coercionar | Puede coerciona exitosamente
----              |----         | ----
