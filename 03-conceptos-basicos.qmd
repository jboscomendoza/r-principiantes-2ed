...
Cuando llamamos una función, se realizan las operaciones que se le han asignado usando los argumentos establecidos y se nos devuelve el resultado de ellas.
...
Las funciones son el tema del [Capítulo @sec-funciones], por el momento recuerda que una función realiza operaciones y nos pide argumentos para poder llevarlas a cabo.
...
Si usas Positron o RStudio la documentación de la función se mostrará en uno de los paneles de esta IDE y si estas usando R directamente se abrirá una ventana de tu navegador de Internet.
