...
Para instalar RStudio, es necesario con descargar y ejecutar alguno de los instaladores disponibles en su sitio oficial. Están disponibles versiones para Windows MacOS y Linux.
...
## Positron - un IDE para análisis de datos

Positron es una IDE especializada en ciencia de datos que permite trabajar con R y Python de manera nativa. Esta IDE es desarrollada por Posit, los creadores de RStudio, y es la IDE que uso actualmente. 

* <https://positron.posit.co/>

Positron es, esencialmente, una versión especializada de [VSCode](https://code.visualstudio.com/), la IDE de uso general desarrollada por Microsoft, lo cual trae consigo el beneficio de tener acceso a muchas de las extensiones desarrolladas por ella.

Al igual que RStudio, Positron detectará automáticamente las instalaciones de R y Python en nuestro sistema.
