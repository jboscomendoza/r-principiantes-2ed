...
En R, podemos extraer partes de una estructura de datos y a estas las denominamos como **subconjuntos**. Hacemos esto para seleccionar datos con características específicas, por ejemplo, todos los valores mayores a cierto número o aquellos que coinciden exactamente con un valor de nuestro interés.

Para obtener subconjuntos hacemos uso de índices, operadores lógicos y álgebra Booleana, además de que contamos con varios procedimientos para ello. Algunos de estos procedimientos pueden usarse con cualquier estructura de datos y otros sólo funcionan con algunas de ellas.
