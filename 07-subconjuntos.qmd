...
Para extraer múltiples elementos no es necesario que estos estén uno al lado del otro en la estructura de datos, podemos elegir posiciones específicas usando vectores. Si queremos extrar el primer y cuarto elenmento hacemos lo siguiente.
...
Esto nos muestra que el uso de índices tiene consideradores particulares para las distintas estructuras de datos, así que revisaremos este procedimiento para cada una de ellas.
