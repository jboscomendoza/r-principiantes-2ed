...
```{r bar_col, echo=TRUE}
plot(x = factor(banco$education), main = "Gráfica de Educacíón",
...
plot(x = banco$age, y = banco$balance, col= c("red", "blue"))
```
...
plot(x = factor(banco$education), y = banco$age, main = "Edad por nivel educativo", 
...
plot(x = banco$age, y = banco$duration, col = c("Black", "Red"), 
